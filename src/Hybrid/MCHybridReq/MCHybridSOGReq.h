#ifndef MCHybridSOGReq_H
#define MCHybridSOGReq_H
...
enum class statereq {waitInitial,waitingBuild,waitingSucc};
// typedef vector<Trans> vec_trans;
class MCHybridSOGReq : public CommonSOG
{
public:
